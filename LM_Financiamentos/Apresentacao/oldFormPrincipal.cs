...
namespace LM_Financiamentos.Apresentacao
{
    public partial class FormPrincipal : Form
    {
        ...
        private void hideSubMenu()
        {
            ...
            panelCadastroSubMenuIco.Visible = false;

        }
        private void showSubMenu(Panel subMenu, Panel subMenuIco)
        {
        ...
        private void CloseForms(object sender, FormClosedEventArgs e)
        {
            if (Application.OpenForms["Form_Controle_Doc"] == null)
                btncdoc.BackColor = Color.FromArgb(4, 41, 68);
            if (Application.OpenForms["Form_Cadastro_cliente"] == null)
            {
                if (Application.OpenForms["Form_Cadastro_Fornecedor"] == null)
                {
                    ...
                    btncadcli.BackColor = Color.FromArgb(4, 41, 68);
                }
                else
                {
                    btncadcli.BackColor = Color.FromArgb(4, 41, 68);
        ...
        {
            showSubMenu(panelCadastroSubMenu, panelCadastroSubMenuIco);

        }

        private void btncdoc_Click(object sender, EventArgs e)
        {
            AbrirFormulario<Form_Controle_Doc>();
        ...
        private void btncadcli_Click(object sender, EventArgs e)
        {
            ...
            btncadastro.BackColor = Color.FromArgb(12, 61, 92);
            btncadcli.BackColor = Color.FromArgb(12, 61, 92);
            //..
            //your codes
            //..
            hideSubMenu();
        ...
        private void btnicocdoc_Click(object sender, EventArgs e)
        {
            AbrirFormulario<Form_Controle_Doc>();
            btncdoc.BackColor = Color.FromArgb(12, 61, 92);
            //..
