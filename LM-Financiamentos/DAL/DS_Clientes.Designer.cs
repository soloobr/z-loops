...
namespace LMFinanciamentos.DAL {
    ...
    public partial class DS_Clientes : global::System.Data.DataSet {
        ...
        public partial class ClientesDataTable : global::System.Data.TypedTableBase<ClientesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ClientesRow AddClientesRow(string Nome, string Email, string Telefone, string CPF, string RG, string Sexo, string Status) {
...
namespace LMFinanciamentos.DAL.DS_ClientesTableAdapters {
    ...
    public partial class ClientesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Clientes` WHERE ((`id` = @p1) AND ((@p2 = 1 AND `Nome` IS NULL) OR (`Nome` = @p3)) AND ((@p4 = 1 AND `Email` IS NULL) OR (`Email` = @p5)) AND ((@p6 = 1 AND `Telefone` IS NULL) OR (`Telefone` = @p7)) AND ((@p8 = 1 AND `CPF` IS NULL) OR (`CPF` = @p9)) AND ((@p10 = 1 AND `RG` IS NULL) OR (`RG` = @p11)) AND ((@p12 = 1 AND `Sexo` IS NULL) OR (`Sexo` = @p13)) AND ((@p14 = 1 AND `Status` IS NULL) OR (`Status` = @p15)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Clientes` (`Nome`, `Email`, `Telefone`, `CPF`, `RG`, `Sexo`, `Status" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Clientes` SET `Nome` = @p1, `Email` = @p2, `Telefone` = @p3, `CPF` = @p4, `RG` = @p5, `Sexo` = @p6, `Status` = @p7 WHERE ((`id` = @p8) AND ((@p9 = 1 AND `Nome` IS NULL) OR (`Nome` = @p10)) AND ((@p11 = 1 AND `Email` IS NULL) OR (`Email` = @p12)) AND ((@p13 = 1 AND `Telefone` IS NULL) OR (`Telefone` = @p14)) AND ((@p15 = 1 AND `CPF` IS NULL) OR (`CPF` = @p16)) AND ((@p17 = 1 AND `RG` IS NULL) OR (`RG` = @p18)) AND ((@p19 = 1 AND `Sexo` IS NULL) OR (`Sexo` = @p20)) AND ((@p21 = 1 AND `Status` IS NULL) OR (`Status` = @p22)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        id, Nome, Email, Telefone, CPF, RG, Sexo, Status\r\nFROM            C" +
                "lientes";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::MySql.Data.MySqlClient.MySqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        id, Nome, Email, Telefone, CPF, RG, Sexo, Status\r\nFROM            C" +
                "lientes\r\nWHERE        (Nome = @nome)";
        ...
        public virtual int FillBy(DS_Clientes.ClientesDataTable dataTable, string nome) {
        ...
        public virtual DS_Clientes.ClientesDataTable GetDataBy(string nome) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((nome == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
