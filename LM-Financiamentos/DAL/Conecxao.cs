        ...
        public Conecxao(string server)
        {
            ...
            switch (DefaultVolume)
            {
                ...
                case "ONLINE":
                    ...
                    break;
                case "HOMOLOGACAO":
                    con.ConnectionString = @"server=SERVIDOR;user id = u371409358_lm;Password=P@ssw0rd; database=u371409358_lm_h;persistsecurityinfo=True;convert zero datetime=True";
                    break;
                default:
                    con.ConnectionString = @"server=SERVIDOR;user id = u371409358_lm;Password=P@ssw0rd; database=u371409358_lm;persistsecurityinfo=True;convert zero datetime=True";
                    break;
